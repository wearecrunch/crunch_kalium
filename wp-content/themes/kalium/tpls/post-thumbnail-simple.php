...
// External Post Link
if ( $post_format == 'link' ) {
	$post_link = laborator_extract_post_content( 'link', true );
...
if ( $post_thumbnail_id ) :
	laborator_show_image_placeholder( $post_thumbnail_id, apply_filters( 'kalium_blog_thumbnail_size', $thumb_size ), '', $blog_post_list_lazy_load );
else :
