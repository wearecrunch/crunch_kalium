			...
			if ( $gallery_item['acf_fc_layout'] == 'image' ) :
				...
				<div class="<?php echo implode( ' ', $column_classes ); ?>">
					<div class="<?php echo implode( ' ', $item_classes ); ?>">
						<a href="<?php echo $is_video ? esc_url( $alt_text ) : esc_url( $href ); ?>" title="<?php echo esc_attr( apply_filters( 'kalium_portfolio_lightbox_image_caption', $caption ) ); ?>" data-lightbox-gallery="post-gallery">
			...
			if ( $gallery_item['acf_fc_layout'] == 'text_quote' ) :
				...
				<div class="<?php echo implode( ' ', $column_classes ); ?>">
					<blockquote>
						...
						<?php if ( $quote_author ) : ?>
							<span>- <?php echo lab_esc_script( $quote_author ); ?></span>
						<?php endif; ?>
					</blockquote>
				</div>
				<?php
