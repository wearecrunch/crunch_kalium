...
$of_options[] = array(	"name" 		=> "Custom Logo",
						"desc" 		=> "Upload/choose your custom logo image<br><small><span class=\"note\">Note:</span> If you want to upload SVG logo please <a href=\"https://wordpress.org/plugins/svg-support/\" target=\"_blank\">install this plugin</a>.</small>",
...
$of_options[] = array( 	"desc" 		=> "Set maximum width for uploaded logo (in pixels)",
...
$of_options[] = array( 	"type" 		=> "tabs",
						...
						"tabs"		=> array(
							...
							'header-settings-position'       => 'Header Position',
...
$of_options[] = array(	"name"		=> "Styling Options",
						"desc" 		=> "Vertical padding when sticky is active<br /><small><span class=\"note\">Note:</span> Only numeric value is accepted</small>",
...
$of_options[] = array(	"name"		=> "Other Settings",
						"desc"   	=> "Immediate sticky<br><small>Activate sticky menu immediately on first scroll.</small>",
						"id"   		=> "header_sticky_immediate",
						"std"   	=> 0,
						"on"  		=> "Yes",
						"off"  		=> "No",
						"type"   	=> "switch",
...
$of_options[] = array(	#"name"		=> "Mobile Mode",
						"desc"   	=> "Sticky menu on Mobile Mode<br><small><span class=\"note\">Note:</span> Enable or disable sticky menu on mobile.</small>",
...
$of_options[] = array( 	"desc" 		=> "Set maximum width for the uploaded logo, mostly used when you use upload retina (@2x) logo. Pixels unit (optional)<br /><small><span class=\"note\">Note:</span> Even if you don't upload custom logo, you may set custom width for the current logo in sticky menu.</small>",
...
$of_options[] = array( 	"name"		=> "Skin Style",
...
$of_options[] = array( 	"name" 		=> "Text Color",
						"desc" 		=> "Select footer text color. Inverted will turn font color to white",
						"id" 		=> "footer_style",
						"std" 		=> '',
						"type" 		=> "select",
						"options"	=> array(
...
$of_options[] = array( 	"name" 		=> "Custom Javascript",
						"desc" 		=> "Add your JavaScript code here. This will be added into the footer template, you can also add analytics code here.<br /><small><span class=\"note\">Example:</span> Google Analytics tracking code can be added here.</small>",
						"id" 		=> "user_custom_js",
						"std" 		=> "",
						"type" 		=> "textarea",
...
$of_options[] = array( 	"desc" 		=> "Default item spacing (in pixels)<br><small><span class=\"note\">Note:</span> Enter numeric values only. Not applied when &quot;Merged&quot; spacing is selected.</small>",
...
if ( $portfolio_prefix_url_slug_placeholder )  {
	...
	$of_options[] = array( 	"desc"		=> "Custom portfolio item URL prefix<br><small><span class=\"note\">Note:</span> When you change this setting you need to <a href=\"" . admin_url( 'themes.php?page=laborator_docs#flush-rewrite-rules' ) . "\" target=\"_blank\">flush rewrite rules</a>.</small>",
...
$of_options[] = array( 	"desc" 		=> "Information under the title<br><small><span class=\"note\">Note:</span> Select type of content you want to show under portfolio titles in the loop.</small>",
...
$of_options[] = array( 	"desc" 		=> "Image size for gallery items<br><small><span class=\"note\">Note:</span> Enter defined image size. Click <a href=\"https://codex.wordpress.org/Function_Reference/the_post_thumbnail#Thumbnail_Sizes\">here</a> to learn more.</small>",
...
$of_options[] = array( 	"desc" 		=> "Image size for thumbnails<br><small><span class=\"note\">Note:</span> Enter defined image size. Click <a href=\"https://codex.wordpress.org/Function_Reference/the_post_thumbnail#Thumbnail_Sizes\">here</a> to learn more.</small>",
...
$of_options[] = array( 	"desc" 		=> "Thumbnail size<br><small><span class=\"note\">Note:</span> Enter numeric value only.</small>",
...
$of_options[] = array( 	"desc" 		=> "Thumbnail container height<br><small><span class=\"note\">Note:</span> Enter numeric value only.</small>",
...
$of_options[] = array( 	"name"		=> "Share Product",
						"desc" 		=> "Enable product sharing on popular social networks",
...
$of_options[] = array( 	"name" 		=> "Custom CSS",
						...
						<p>To add your own Custom CSS for this theme, click on the below button and start applying custom styling for this theme only.</p>
