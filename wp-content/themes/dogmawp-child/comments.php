...
<input class="form-control"  onClick="this.select()" value="" placeholder="<?php esc_attr_e('Name','dogmawp'); ?>" type="text" name="author" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
<span id="author" class="validation">Name is required</span>


<input class="form-control"  onClick="this.select()" value="" placeholder="<?php esc_attr_e('Website','dogmawp'); ?>" type="text" name="url" size="22" tabindex="2" />


<input class="form-control"  onClick="this.select()" value="" placeholder="<?php esc_attr_e('Email','dogmawp'); ?>" type="text" name="email" size="22" tabindex="3"/>
<span id="email" class="validation">Email is required</span>
...
<textarea class="form-control" rows="3" name="comment" cols="100" tabindex="4" onClick="this.select()" <?php if ($req) echo "aria-required='true'"; ?> placeholder="<?php esc_attr_e('Message','dogmawp'); ?>"></textarea>
...
<script type="text/javascript">
	...
	var defValues = ["Name", "Email", "Message"];
	jQuery(function($) {
